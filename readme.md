...
> [!TIP]
> Tra gli sviluppi futuri l'[aggiornamento dei componenti deprecati](frontend.md#TIP) nel frontend per garantire la compatibilità e le prestazioni ottimali del sistema.
